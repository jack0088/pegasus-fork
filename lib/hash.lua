--[[
    ...
    * with bit LUT
    ...
    found on https://bitbucket.org/Boolsheet/sil/raw/tip/hash.lua
]]
...
-- utils are part of https://bitbucket.org/Boolsheet/bslf
...
local function intstr(num, int_bytes, signed, big_endian, ones_complement)
